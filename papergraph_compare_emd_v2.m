...
%%
figure("Position",[2045,108,662,846]);
ax = tiledlayout(4,2,'TileSpacing','tight');
for i=1:4
...
if i==1;title("SVD",'FontName','Times New Roman');end
axis tight
set(gca,'FontName','Times New Roman','FontSize',12)
...
nexttile()
plot(taxis,emdraw(:,i))
if i==1;title("EMD",'FontName','Times New Roman');end
axis tight
set(gca,'FontName','Times New Roman','FontSize',12)
